            ...
            <div className="us6Content">
                ...
                <form className="us6Form">
                    <div className="us6FormGroup">
                        ...
                        <input type="text" name="fname" className="us6Input" onChange={hf} placeholder="Enter your first name"/>
                    </div>
                    <div className="us6FormGroup">
                        <label className="us6Label">Last Name</label>
                        <input type="text" name="lname" className="us6Input" onChange={hf} placeholder="Enter your last name"/>
                    </div>
                </form>
